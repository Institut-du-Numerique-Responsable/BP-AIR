...
1. Animer des ateliers de **priorisation** (matrice impact / effort) des chantiers techniques : décommissionnement, refactoring, migration, standards futurs.
2. Évaluer **coûts, délais, risques et gains** de chaque action.
3. Rédiger des **fiches actions** assignées à des pilotes ; intégrer au **schéma directeur** et au budget annuel.
...
- Plan technocratique non relié à la valeur métier → rejet en CODIR.
