...
1. **Cartographier** les parties prenantes (attentes, craintes, influence).
2. Organiser des **ateliers de sensibilisation et de co-construction** adaptés à chaque public.
...
- Communiquer un discours unique à des publics hétérogènes (un dev et un acheteur n'ont pas les mêmes leviers).
