...
version: 0.1
maj: 2026-06-04
fiches_liees: [G2, G3, G4]
---

# G1 — Initialiser la démarche (obtenir le mandat)

> **Public cible.** Direction (DSI, RSE, DAF), futur Référent NR, architectes.
...
1. Rédiger une **proposition de valeur** (business case) chiffrée : économies d'énergie, réduction de dette technique, image de marque, conformité réglementaire.
...
- Lancer sans mandat formel → la démarche s'essouffle au premier conflit de priorité.
