...
1. Animer des **ateliers de définition** d'objectifs (faisabilité technique, indicateurs).
2. **Benchmarker** le secteur pour calibrer des objectifs ambitieux mais réalistes.
