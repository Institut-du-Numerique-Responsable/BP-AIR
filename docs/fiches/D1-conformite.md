...
- **KPI** : % d'actions de la feuille de route démarrées ; taux de consommation du budget ; jalons atteints dans les délais ; preuves de conformité archivées par jalon.
