...
La conformité NR a cessé d'être volontaire. Ce tableau recense les textes qui
contraignent directement un SI, avec leurs échéances. Les dates comptent autant que
les obligations : c'est ce qui transforme un chantier NR en projet arbitré et budgété
plutôt qu'en *nice-to-have*, l'argument que cherche la fiche [G1](G1-mandat.md).
...
| **RGESN** (ARCEP / ARCOM), article 25 de la loi REEN | Services numériques de l'État et des collectivités de plus de 50 000 habitants | Applicable **depuis 2024** | **Déclaration d'écoconception à publier** sur le service. Grille d'audit directement exploitable. Cf. [C1](C1-eco-conception-services.md) |
...
!!! warning "Vérifier avant de s'engager"
    Périmètres et échéances de la CSRD et de l'AI Act ont été modifiés par les
    directives et règlements omnibus de 2025-2026, et certains textes de transposition
    restent en cours. Confirmer l'applicabilité auprès de la direction juridique avant
    d'inscrire une échéance dans une feuille de route.

**La lecture d'architecte.** Ces textes convergent vers trois livrables qui sont, en
pratique, les mêmes : un **inventaire** (des équipements, des données, des systèmes
d'IA), une **traçabilité** des mesures et des **preuves archivées**. Les construire
une fois et les servir à plusieurs réglementations coûte nettement moins que d'ouvrir
un chantier par texte.
...
5. **Tenir la cartographie des obligations** : quels textes s'appliquent, à quel
   périmètre du SI, à quelle échéance, et qui en porte la responsabilité. La revoir
   au moins une fois par an, car les périmètres bougent.
...
- Traiter la conformité réglementaire comme un sujet purement juridique : l'AI Act
  et la CSRD réclament des inventaires et de la traçabilité, qui sont des livrables
  d'architecture.
