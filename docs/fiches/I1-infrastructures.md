---
id: I1
titre: Optimiser infrastructures et environnements
description: >-
...
La consolidation peut réduire la consommation de **30 à 60 %**. Le stockage virtuel « indolore » ne l'est pas : multiplier les environnements a un coût réel. Voir le [guide](../guide-unifie.md#26-pilier-5-architecture-logicielle-sobre-eco-conception).
